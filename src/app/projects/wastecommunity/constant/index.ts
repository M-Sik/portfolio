...
export const troubleShootings = [
  {
    ...
    contents: [
      ...
      },
      {
        subTitle: '[원인 파악]',
        content:
          '스크롤 이벤트는 굉장히 자주 발생하는 이벤트이며, 이벤트가 발생할 때마다 등록한 콜백 함수가 실행되며 발생한 문제라는 것을 알게 되었습니다. 또한 무한스크롤 구현하기 위해 scrollTop의 값을 참조하는데, scrollTop의 경우 무수히 많이 호출될 시 Reflow가 발생해 성능 저하 문제가 생길수도 있다고 하여 스크롤 이벤트 콜백 함수의 호출을 줄여야겠다고 생각했습니다.',
      },
      {
        subTitle: '[해결 방법]',
        content:
